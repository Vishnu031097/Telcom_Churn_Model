...
# Load the csv file
df = pd.read_csv(r"D:\personal stuff\ANEESH SHARMA\PROFESSIONAL COURSES\HERO VIRED DATA ANALYST\COURSE CIRRICULAM\CAPSTONE PROJECT\ML-MODEL-DEPLOYMENT-USING-FLASK-main (1)\ML-MODEL-DEPLOYMENT-USING-FLASK-main\ML-MODEL-DEPLOYMENT-USING-FLASK-main\Dataset.csv")
